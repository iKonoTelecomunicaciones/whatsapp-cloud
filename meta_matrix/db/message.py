...
class Message:
    ...
    async def insert(self) -> None:
        q = """
            ...
            meta_message_id, app_page_id) VALUES ($1, $2, $3, $4, $5, $6)
        """
    ...
    async def get_all_by_app_page_id(cls, page_id: MetaPageID) -> Iterable["Message"]:
        q = """
            SELECT event_mxid, room_id, ps_id, sender, meta_message_id, app_page_id
    ...
    @classmethod
    async def get_by_meta_id(cls, meta_message_id: MetaMessageID) -> Optional["Message"]:
        q = """
            SELECT event_mxid, room_id, ps_id, sender, meta_message_id, app_page_id
            FROM message WHERE meta_message_id=$1
        """
