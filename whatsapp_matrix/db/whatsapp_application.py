...
class WhatsappApplication:
    ...
    _columns = "business_id, wb_phone_id, name, admin_user, page_access_token"
    ...
    async def update(
        ...
        q = """
            ...
            SET name=$1, admin_user=$2, business_id=$3, wb_phone_id=$4 ,page_access_token=$5 WHERE name=$1
        """
